...
<html lang="en">
  <head>
    ...
    <title>Dashboard Admin - DCom</title>
    <link rel="icon" href="{{ asset('Assets/image/logomain.png') }}" type="image/x-icon">
    <link rel="shortcut icon" href="{{ asset('Assets/image/logomain.png') }}" type="image/x-icon">
  ...
  <body>
    ...
    <div class="container-fluid">
        ...
        <a href="{{ route('home') }}" class="navbar-brand navbar-brand-autodark mt-3">
            <img src="{{ asset('Assets/image/logomain.png') }}" width="110" height="32" alt="HFS" class="navbar-brand-image">
        </a>
                    ...
                    <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                        <ul class="list-inline list-inline-dots mb-0">
                            <li class="list-inline-item">
                                ...
                                <a href="." class="link-secondary">DTulip.Ecom</a>.
                                All rights reserved.
                            </li>
                        </ul>
                    </div>
