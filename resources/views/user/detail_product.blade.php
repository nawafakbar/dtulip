...
@section('title', $product->name . ' - DTulip')

@section('content')
<main class="product-detail-page mt-5 pt-5">
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                {{-- 1. INPUT HIDDEN: Kirim ID Produk yang benar --}}
                <input type="hidden" name="product_id" value="{{ $product->id }}">

                {{-- 2. INPUT QUANTITY: Kirim jumlah barang --}}
                <div class="d-flex align-items-center mb-3">
                    <label class="me-3 fw-bold">Jumlah (Stok: {{ $product->stock }})</label>
                ...
                <div class="product-meta">
                    ...
                    <p><i class="bi bi-instagram me-2"></i> Dtulip Cake & Cookies </p>
                </div>
            </div>
        </div>
