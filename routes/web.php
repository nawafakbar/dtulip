...
|--------------------------------------------------------------------------
*/
//cek id kecamatan padang
// Route::get('/debug-total', function () {
//     // 1. Tulis API Key kamu langsung di sini (Hardcode)
//     $apiKey = 'Ytw5qRf84a9615933dd0698eBJNsOede'; 

//     // TEST A: Coba Tembak Server OFFICIAL RAJAONGKIR (Akun PRO/BASIC)
//     // URL: https://pro.rajaongkir.com/api
//     $tryPro = Http::withHeaders(['key' => $apiKey])
//                 ->get('https://pro.rajaongkir.com/api/province');

//     // TEST B: Coba Tembak Server OFFICIAL RAJAONGKIR (Akun STARTER/GRATIS)
//     // URL: https://api.rajaongkir.com/starter
//     $tryStarter = Http::withHeaders(['key' => $apiKey])
//                 ->get('https://api.rajaongkir.com/starter/province');

//     // TEST C: Coba Tembak Server KOMERCE (Sesuai tutorial kamu)
//     $tryKomerce = Http::withHeaders(['key' => $apiKey])
//                 ->get('https://rajaongkir.komerce.id/api/v1/destination/district/397');

//     return [
//         'ANALISA' => 'Lihat mana yang status-nya code 200, itulah tipe akun kamu yang benar.',
//         '1_OFFICIAL_PRO' => $tryPro->json(),
//         '2_OFFICIAL_STARTER' => $tryStarter->json(),
//         '3_KOMERCE_SERVER' => $tryKomerce->json(),
//     ];
// });
...
Route::get('/katalog', function () {
    ...
    // Kirim data $products ke view catalog
